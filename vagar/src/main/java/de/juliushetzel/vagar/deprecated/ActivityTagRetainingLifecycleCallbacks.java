...
public final class ActivityTagRetainingLifecycleCallbacks extends TagRetainingLifecycleCallbacks<Activity> implements Application.ActivityLifecycleCallbacks{
    private static final String TAG = ActivityTagRetainingLifecycleCallbacks.class.getSimpleName();
    private static final boolean DEBUG = true;

    public ActivityTagRetainingLifecycleCallbacks(Activity target, String tag, long id) {
        super(target, tag, id);
    }
